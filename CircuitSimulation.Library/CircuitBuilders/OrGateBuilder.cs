...
{
    public class OrGateBuilder : ElementBuilder<OrGate, OrGateData>
    {
        protected override OrGate Build(OrGateData data, Simulation simulation)
        {
            var gate = new OrGate(data.Delay, simulation);
            gate.Id = data.Id;
